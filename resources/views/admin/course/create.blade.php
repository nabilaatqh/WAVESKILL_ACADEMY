        ...
        <form action="{{ route('admin.course.store') }}" method="POST" enctype="multipart/form-data">
            ...
            <div class="mb-3">
                ...
                <textarea name="deskripsi" id="deskripsi" rows="4"
                          ...
                          placeholder="Masukkan deskripsi singkat...">{{ old('deskripsi', $course->deskripsi ?? '') }}</textarea>
                @error('deskripsi')
                    <div class="invalid-feedback">{{ $message }}</div>
                @enderror
            </div>
            ...
            <div class="mb-3">
                ...
                @if(isset($course->banner_image))
                    <div class="mt-3">
                        ...
                        <img src="{{ asset('storage/' . $course->banner_image) }}" alt="Banner" class="img-fluid rounded" style="max-width: 300px;">
                    </div>
                @endif
            </div>
