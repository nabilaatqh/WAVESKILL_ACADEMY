        ...
        <form action="{{ route('student.profile.update') }}" method="POST" enctype="multipart/form-data">
            ...
            <div class="profile-photo-wrapper">
                <label for="photo-input" title="Klik untuk ganti foto profil">
                    <img id="preview-photo" src="{{ $student->photo ? Storage::url($student->photo) : asset('images/avatar-placeholder.png') }}" alt="Foto Profil">
                </label>
            ...
            <input type="tel" name="phone" id="phone" value="{{ old('phone', $student->phone ?? '') }}" required>
            ...
            <input type="date" name="birth_date" id="birth_date" value="{{ old('birth_date', $student->birth_date ?? '') }}" required>
